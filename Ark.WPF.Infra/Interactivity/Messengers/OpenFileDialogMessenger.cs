...
{
    /// <summary>
    /// ファイル選択ダイアログを表示するためのメッセンジャーを表します。
    /// </summary>
    public class OpenFileDialogMessenger : MessengerBase<DependencyObject, OpenFileDialogAction>
    {
        /// <summary>
        /// ファイル選択ダイアログを表示します。
        /// </summary>
        ...
        {
            var args = new OpenFileDialogAction.OpenFileDialogActionArgs
            {
